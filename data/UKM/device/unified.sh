...
case "$1" in
	...
	DirGPUMaxFrequency)
		...
		GPUMAXFREQ4=/sys/class/kgsl/kgsl-3d0/max_gpuclk;
	...
	DirGPUMinPwrLevel)
		...
		GPUMPW4=/sys/class/kgsl/kgsl-3d0/min_pwrlevel;
	...
	GPUFrequencyList)
		...
		GPUFREQ4=/sys/class/kgsl/kgsl-3d0/gpu_available_frequencies;
	...
	GPUPowerLevel)
		...
		GPUPW4=/sys/class/kgsl/kgsl-3d0/num_pwrlevels;
